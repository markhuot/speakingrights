 ...
 *
 * Provides access to Carbon date methods.
 *
 * --snip--
...
class CarbonDatePlugin extends BasePlugin
{
    /**
    ...
    {
        require CRAFT_PLUGINS_PATH.'/carbondate/vendor/autoload.php';
    ...
    {
        return Craft::t('Provides access to Carbon date methods.');
    }
    ...
    {
        return 'https://github.com/joshuabaker/craft-carbon-date/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/joshuabaker/craft-carbon-date/master/releases.json';
    }
    ...
    {
        Craft::import('plugins.carbondate.twigextensions.CarbonDateTwigExtension');

        return new CarbonDateTwigExtension();
    }
}
